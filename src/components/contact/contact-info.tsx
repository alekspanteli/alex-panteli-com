  ...
  return (
    <div className="space-y-12">
      <div>
        ...
        <p className="max-w-sm text-[15px] leading-[1.7] tracking-[-0.01em] text-muted-foreground">
            ...
            {item.href ? (
              <a
                ...
                {...("external" in item && item.external
                  ...
                  : {})}
                className="font-mono text-[15px] font-medium text-heading transition-colors duration-150 hover:text-(--phosphor) focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--phosphor)"
              >
                {item.value}
              </a>
            ) : (
